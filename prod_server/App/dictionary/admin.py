...
from dictionary.models import Cyrillic, Group, Word, WordGroup, TranscriptionList
...
class WordAdmin(admin.ModelAdmin):
    ...
    def view_edit_stress(self, obj):
        return mark_safe(f'<div id="edit_stress"></div>')
    view_edit_stress.short_description = 'Ударение'

    def get_readonly_fields(self, request, obj=None):
        if obj:
            return ['view_on_site_link', 'view_edit_stress']
        else:
            return ['view_edit_stress']
        return []
    ...
    class Media:
        ...
        js = [ static_url+'deps/scripts/edit_stress.js', ]

admin.site.register(WordGroup)
admin.site.register(TranscriptionList)
admin.site.register(Cyrillic)
