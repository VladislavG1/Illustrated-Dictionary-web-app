...
class Group(models.Model):
    ...
    alias_name = models.CharField(unique=True, max_length=128)
...
class TranscriptionList(models.Model):
    letter = models.ForeignKey(Cyrillic, models.DO_NOTHING)
...
class Word(models.Model):
    ...
    transcription = models.CharField(max_length=128, blank=True, null=True)
    example = models.TextField(blank=True, null=True)
    image = models.CharField(max_length=128, blank=True, null=True)
    alias_name = models.CharField(unique=True, max_length=128)
    audio = models.CharField(max_length=128, blank=True, null=True)
